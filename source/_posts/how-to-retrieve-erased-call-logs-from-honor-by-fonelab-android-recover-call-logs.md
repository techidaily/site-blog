---
title: How to retrieve erased call logs from Honor ?
...
keywords: recover lost recent calls from 100,recover lost recent calls from Honor,save erased call logs on Honor,Honor 100 call logs recovery,unerase call numbers from 100,retrieve wiped call logs 100,how to recover call history on Honor 100,how to refind deleted call history from Honor,how can i get call history back on Honor 100,Honor 100 delete call history recover,how can i find my deleted call history 100,how to retrieve call history from Honor
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    You might delete calls from your Honor 100’s call-logs history that you didn’t mean to delete or to which you might need to refer later. You might also want to see the deleted call-log history on someone Honor 100 like your spouse’s Honor 100 to see what he’s been up to.
    Once calls are deleted from your Honor 100, they are still located on the device’s SIM card. Regardless of the reason, you can retrieve a deleted call-log history with the appropriate recovery tool.
  </p>
</div>
</div>
