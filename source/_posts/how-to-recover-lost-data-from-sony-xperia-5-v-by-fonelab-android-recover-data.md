---
title: How to recover lost data from Sony Xperia 5 V?
...
categories: 
  ...
  - android
  - data recovery
description: If you've lost data on your Sony Xperia 5 V you know how important it is to get it back. Follow these steps on how to recover lost data on Sony Xperia 5 V.
keywords: Sony Xperia 5 V data retrieval,Sony Xperia 5 V files disappear,Sony Xperia 5 V files lost,save lost data on Sony Xperia 5 V,Regain missing files on Sony,retrieve deleted files Sony,Sony Xperia 5 V issues with data deleted,extract data from water damaged phone Xperia 5 V,lost all data in Xperia 5 V again,Xperia 5 V data deleted itself,how to refind deleted data from Sony,how to get back deleted data Sony phone
---
...
If you've lost data on your Sony Xperia 5 V you know how important it is to get it back. Follow these steps on how to recover lost data on Sony Xperia 5 V.
</div>
...
<div class="tpl-content-sub-paragraph-question">
    "Do you know how can I get back my lost document on my Sony Xperia 5 V?"
</div>
</div>


<ul>
  <li>Part 1: <strong><a href="#p1">How to recover lost data from Sony Xperia 5 V? (on macOS)</a></strong></li>
  <li>Part 2: <strong><a href="#p2">How to recover lost data from Sony Xperia 5 V? (on Windows)</a></strong></li>
</ul>
...
<div>
  <span class="atpl-step-part-style">Part 1. How to recover lost data from Sony Xperia 5 V? (on macOS)</span>
</div>  
...
Android Data Recovery will prompt you to enable USB debugging on your Sony Xperia 5 V  if you don't open the debugging mode. The program will detect the version of your Sony Xperia 5 V device automatically and give you the instruction of opening the USB debugging mode on your Xperia 5 V. After finishing the operations on your phone, click <strong>"OK"</strong> button.
...
<!-- Part 2 -->
<div>
  <span class="atpl-step-part-style">Part 2. How to recover lost data from Sony Xperia 5 V? (on Windows)</span>
</div>
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    With wizard-like user interface, you just need to follow simple prompts to finish Sony Xperia 5 V recovery. No prior skill is required. Every Sony user can recover lost data with no effort.
  </p>
</div>
</div>
