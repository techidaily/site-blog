...
categories: 
  ...
  - android
  - data recovery
description: "Accidentally lost all my contacts on Google Pixel 8 after I updated my Google Pixel 8, and forgot to back them up. What should I do to recover my lost contacts from my Google Pixel 8 without backup? Any advice will be appreciated."
keywords: undelete contacts from Google,restore deleted phone number on Google Pixel 8,save erased contacts from Google Pixel 8,Google Pixel 8 contacts recovery,recover lost contacts from Google Pixel 8,recover lost contacts from Pixel 8,restore contacts when deleted in Google,extract contacts from water damaged phone Pixel 8,how to recover contacts in Google,how to retrieve contacts from Google,deletes contacts of Google Pixel 8,how to retrieve deleted contacts from my Pixel 8
---
...
"Accidentally lost all my contacts on Google Pixel 8 after I updated my Google Pixel 8, and forgot to back them up. What should I do to recover my lost contacts from my Google Pixel 8 without backup? Any advice will be appreciated."
</div>
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Therefore, you must stop adding new contacts to your cell phone if data loss happens. There are ways to retrieve a deleted contact on Google Pixel 8 either from internal storage or SD card via Gmail or Android Contacts Recovery.
  </p>
</div>
</div>
...
<ul>
  <li>Part 1: <strong><a href="#p1"> How to recover deleted contacts from Google .  (on macOS)</a></strong></li>
  <li>Part 2: <strong><a href="#p2"> How to recover deleted contacts from Google .  (on Windows)</a></strong></li>
</ul>
...
<div>
  <span class="atpl-step-part-style">Part 1. How to recover deleted contacts from Google . (on macOS)</span>
</div>  
...
<!-- Part 2 -->
<div>
  <span class="atpl-step-part-style">Part 2. How to recover deleted contacts from Google . (on Windows)</span>
</div>
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    If your Google Pixel 8 device is damaged seriously, you may lost your contacts without the possibility to recover them back. That’s why we kindly suggest you back up your Google Pixel 8 regularly.
  </p>
</div>
</div>
