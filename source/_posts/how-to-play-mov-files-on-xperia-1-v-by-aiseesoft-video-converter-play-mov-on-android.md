---
title: How to play MOV files on Xperia 1 V ?
date: 2024-04-07T02:11:30.833Z
tags: 
  - mov video
  - mov android
categories: 
  ...
  - aiseesoft
  - video converter
description: If you try to play .mov files on Sony Xperia 1 V, you may encounter issues one or another. That’s because .mov files don't play well on Android devices. However, this problem can be solved via converting MOV files to MP4 format. 
keywords: can't open .mov on Sony ,does mov play on Xperia 1 V,watch .mov on Sony Xperia 1 V,mov to Xperia 1 V converter,best app to play .mov on Sony Xperia 1 V,does mov play on Sony Xperia 1 V,mov converter android 2018,mov converter for android,playing mov videos on phone android,tv Sony mov 265,mov to h264 converter android,mov video converter for android
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    If you are trying to play QuickTime .mov files on Sony Xperia 1 V, you may encounter issues one or another. That’s because .mov files don't play well on most Android devices. However, this problem can be solved via converting MOV files to Sony Xperia 1 V supported MP4 format. 
  </p>
</div>
</div>
