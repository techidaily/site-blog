...
keywords: play mts clips on HTC U23,play avchd files on HTC ,mts playback on U23,play mts clips on HTC ,mts converter for U23,HTC  playback AVCHD,mts converter android 2018,mts video converter for android,mts codec vlc android,mts converter for android,best mts transcoder android,mts file not supported in HTC U23
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Surprised to find that your HTC U23 does not come with native support for AVCHD .MTS format used in many video cameras? By installing a third party media player like MX player will solve your problem. If this doesn’t work or you prefer to use the stock player, you can convert AVCHD files to MP4 format for playing on HTC U23.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “I'm trying to figure out what I'm going to do with AVCHD .mts files on my HTC U23. They were taken with a Panasonic camera. I’d like to watch them on HTC U23, but it refused to play them. So I'm stuck. Has anyone else figured out how to play the files in this .mts format on HTC U23? Any suggestions?”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  The native video player on your HTC U23 will not support AVCHD files. However, you have two options to go through the issue. You can either install a third party video player (e.g. VLC player, MX player, MoboPlayer, etc.) or convert AVCHD .mts files to MP4 format via using a converter app. Check out a guide on how to re-encode AVCHD .mts files for playing on HTC U23.
</p>
</div>
</div>
