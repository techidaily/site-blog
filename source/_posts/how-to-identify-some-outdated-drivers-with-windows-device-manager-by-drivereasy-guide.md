...
categories: 
  - apps
  - windows
description: This article describes how to identify some outdated drivers with Windows Device Manager
keywords: install drivers,windows 10,update drivers,windows 7
---
